...
func main() {
	...
	if cfg.Agones.Enabled {
		if err := agones.Setup(cfg.Agones.Enabled, cfg.Agones.AllocatorHost, cfg.Agones.AllocatorClientCert, cfg.Agones.AllocatorClientKey, cfg.Agones.AllocatorCACert); err != nil {
